  ...
  (t.cleanData = function (e) {
    ...
    (t.widget = function (i, a, n) {
      ...
      (i = i.split(".")[1]),
        ...
        (o.prototype = t.widget.extend(
          ...
          u,
          { constructor: o, namespace: c, widgetName: i, widgetFullName: s }
        )),
        r
        ...
        for (n in r[o])
          (s = r[o][n]),
            r[o].hasOwnProperty(n) &&
              s !== e &&
              (i[n] = t.isPlainObject(s)
                ? t.isPlainObject(i[n])
                  ? t.widget.extend({}, i[n], s)
                  : t.widget.extend({}, s)
                : s);
      return i;
    }),
    (t.widget.bridge = function (i, n) {
      ...
      t.fn[i] = function (r) {
        var o = "string" == typeof r,
          ...
          u = this;
        return (
          (r = !o && l.length ? t.widget.extend.apply(null, [r].concat(l)) : r),
          o
            ? this.each(function () {
                var a,
                  n = t.data(this, s);
                return n
                  ? t.isFunction(n[r]) && "_" !== r.charAt(0)
                    ? ((a = n[r].apply(n, l)),
                      a !== n && a !== e
                        ? ((u = a && a.jquery ? u.pushStack(a.get()) : a), !1)
                        : e)
                    : t.error(
                        "no such method '" +
                          r +
    ...
    (t.Widget.prototype = {
      ...
      option: function (i, a) {
        ...
        if ("string" == typeof i)
          if (((o = {}), (n = i.split(".")), (i = n.shift()), n.length)) {
            for (
              s = o[i] = t.widget.extend({}, this.options[i]), r = 0;
              n.length - 1 > r;
              r++
            )
              (s[n[r]] = s[n[r]] || {}), (s = s[n[r]]);
            if (((i = n.pop()), 1 === arguments.length))
              return s[i] === e ? null : s[i];
            s[i] = a;
          } else {
      ...
      _on: function (i, a, n) {
        var s,
          r = this;
        "boolean" != typeof i && ((n = a), (a = i), (i = !1)),
          n
            ? ((a = s = t(a)), (this.bindings = this.bindings.add(a)))
            : ((n = a), (a = this.element), (s = this.widget())),
          t.each(n, function (n, o) {
            ...
            "string" != typeof o &&
              (l.guid = o.guid = o.guid || l.guid || t.guid++);
            var u = n.match(/^(\w+)\s*(.*)$/),
              c = u[1] + r.eventNamespace,
              d = u[2];
            d ? s.delegate(d, c, l) : a.bind(c, l);
          });
      },
      _off: function (t, e) {
        (e =
      ...
      _trigger: function (e, i, a) {
        ...
        return (
          ...
          !(
            (t.isFunction(r) &&
              r.apply(this.element[0], [i].concat(a)) === !1) ||
    ...
    t.each({ show: "fadeIn", hide: "fadeOut" }, function (e, i) {
      t.Widget.prototype["_" + e] = function (a, n, s) {
        ...
        var r,
          o = n ? (n === !0 || "number" == typeof n ? i : n.effect || i) : e;
        (n = n || {}),
          "number" == typeof n && (n = { duration: n }),
          (r = !t.isEmptyObject(n)),
          (n.complete = s),
          n.delay && a.delay(n.delay),
          r && t.effects && t.effects.effect[o]
            ? a[e](n)
            : o !== e && a[o]
            ? a[o](n.duration, n.easing, s)
            : a.queue(function (i) {
      ...
      _mouseInit: function () {
        ...
        this.element
          ...
          .bind("click." + this.widgetName, function (a) {
            return !0 === e.data(a.target, t.widgetName + ".preventClickEvent")
              ? (e.removeData(a.target, t.widgetName + ".preventClickEvent"),
          ...
          var i = this,
            ...
            n =
              "string" == typeof this.options.cancel && a.target.nodeName
                ...
                : !1;
          return s && !n && this._mouseCapture(a)
            ? ((this.mouseDelayMet = !this.options.delay),
              ...
              !this._mouseStarted)
                ? (a.preventDefault(), !0)
                : (!0 ===
                    e.data(a.target, this.widgetName + ".preventClickEvent") &&
                    e.removeData(
                      a.target,
...
(function (t, e) {
  ...
  (t.position = {
    ...
    (t.fn.position = function (e) {
      ...
      return (
        (D = s(k)),
        k[0].preventDefault && (e.at = "left top"),
        (p = D.width),
        (f = D.height),
        (m = D.offset),
        (_ = t.extend({}, m)),
        t.each(["my", "at"], function () {
          ...
          1 === a.length &&
            ...
            (e[this] = [h.exec(a[0])[0], h.exec(a[1])[0]]);
        }),
        1 === w.length && (w[1] = w[0]),
        "right" === e.at[0]
          ? (_.left += p)
          : "center" === e.at[0] && (_.left += p / 2),
        "bottom" === e.at[1]
          ? (_.top += f)
          : "center" === e.at[1] && (_.top += f / 2),
        (n = i(b.at, p, f)),
        (_.left += n[0]),
        (_.top += n[1]),
        this.each(function () {
          var s,
            ...
            g = a(this, "marginLeft"),
            D = a(this, "marginTop"),
            M = u + g + a(this, "marginRight") + v.width,
            C = h + D + a(this, "marginBottom") + v.height,
            x = t.extend({}, _),
            I = i(b.my, d.outerWidth(), d.outerHeight());
          "right" === e.my[0]
            ? (x.left -= u)
            : "center" === e.my[0] && (x.left -= u / 2),
            "bottom" === e.my[1]
              ? (x.top -= h)
              : "center" === e.my[1] && (x.top -= h / 2),
            (x.left += I[0]),
            (x.top += I[1]),
            t.support.offsetFractions ||
              ((x.left = l(x.left)), (x.top = l(x.top))),
            (s = { marginLeft: g, marginTop: D }),
            t.each(["left", "top"], function (i, a) {
              t.ui.position[w[i]] &&
                t.ui.position[w[i]][a](x, {
                  targetWidth: p,
                  targetHeight: f,
                  elemWidth: u,
                  elemHeight: h,
            ...
            e.using &&
              (c = function (t) {
                ...
                u > p && p > o(i + a) && (l.horizontal = "center"),
                  h > f && f > o(s + n) && (l.vertical = "middle"),
                  (l.important =
                    r(o(i), o(a)) > r(o(s), o(n)) ? "horizontal" : "vertical"),
                  e.using.call(this, t, l);
              }),
            d.offset(t.extend(x, { using: c }));
        })
      );
    }),
    (t.ui.position = {
      fit: {
        left: function (t, e) {
          var i,
            ...
            l = s - o,
            c = o + e.collisionWidth - n - s;
          e.collisionWidth > n
            ? l > 0 && 0 >= c
              ? ((i = t.left + l + e.collisionWidth - n - s), (t.left += l - i))
              : (t.left =
                  c > 0 && 0 >= l ? s : l > c ? s + n - e.collisionWidth : s)
            : l > 0
            ? (t.left += l)
            : c > 0
            ? (t.left -= c)
            : (t.left = r(t.left - o, t.left));
        },
        top: function (t, e) {
          var i,
            a = e.within,
            ...
            l = s - o,
            c = o + e.collisionHeight - n - s;
          e.collisionHeight > n
            ? l > 0 && 0 >= c
              ? ((i = t.top + l + e.collisionHeight - n - s), (t.top += l - i))
              : (t.top =
                  c > 0 && 0 >= l ? s : l > c ? s + n - e.collisionHeight : s)
            : l > 0
            ? (t.top += l)
            : c > 0
            ? (t.top -= c)
            : (t.top = r(t.top - o, t.top));
        },
      },
      flip: {
        left: function (t, e) {
          var i,
            ...
            g = -2 * e.offset[0];
          0 > d
            ? ((i = t.left + h + p + g + e.collisionWidth - r - n),
              (0 > i || o(d) > i) && (t.left += h + p + g))
            : u > 0 &&
              ((a = t.left - e.collisionPosition.marginLeft + h + p + g - l),
              (a > 0 || u > o(a)) && (t.left += h + p + g));
        },
        top: function (t, e) {
          var i,
            a,
            ...
            f = -2 * e.offset[1];
          0 > d
            ? ((a = t.top + p + g + f + e.collisionHeight - r - n),
              t.top + p + g + f > d &&
                (0 > a || o(d) > a) &&
                (t.top += p + g + f))
            : u > 0 &&
              ((i = t.top - e.collisionPosition.marginTop + p + g + f - l),
              t.top + p + g + f > u &&
                (i > 0 || u > o(i)) &&
                (t.top += p + g + f));
        },
...
(function (e) {
  e.widget("ui.draggable", e.ui.mouse, {
          ...
          : ("parent" === s.containment &&
            ...
            a &&
              ...
              (this.containment = [
                ...
                (t ? Math.max(a.scrollWidth, a.offsetWidth) : a.offsetWidth) -
    ...
    _generatePosition: function (t) {
      ...
      return (
        this.offset.scroll ||
          (this.offset.scroll = { top: o.scrollTop(), left: o.scrollLeft() }),
        this.originalPosition &&
          (this.containment &&
          ...
          n.grid &&
            ((s = n.grid[1]
              ? this.originalPageY +
                Math.round((h - this.originalPageY) / n.grid[1]) * n.grid[1]
              : this.originalPageY),
            (h = i
            ...
            (r = n.grid[0]
              ? this.originalPageX +
                Math.round((l - this.originalPageX) / n.grid[0]) * n.grid[0]
              : this.originalPageX),
            (l = i
            ...
            r
              ? (this.instance.isOver ||
                  ...
                  (this.instance.offset.parent.left -=
                    a.offset.parent.left - this.instance.offset.parent.left),
                  (this.instance.offset.parent.top -=
                    a.offset.parent.top - this.instance.offset.parent.top),
                  a._trigger("toSortable", t),
          ...
          ? ((a.axis && "x" === a.axis) ||
              ...
              a.scrollSensitivity
                ? (i.scrollParent[0].scrollTop = s =
                    i.scrollParent[0].scrollTop + a.scrollSpeed)
            ...
            (a.axis && "y" === a.axis) ||
              ...
              a.scrollSensitivity
                ? (i.scrollParent[0].scrollLeft = s =
                    i.scrollParent[0].scrollLeft + a.scrollSpeed)
          ...
          : ((a.axis && "x" === a.axis) ||
              (t.pageY - e(document).scrollTop() < a.scrollSensitivity
                ? (s = e(document).scrollTop(
                    e(document).scrollTop() - a.scrollSpeed
                  ))
            ...
            (a.axis && "y" === a.axis) ||
              (t.pageX - e(document).scrollLeft() < a.scrollSensitivity
                ? (s = e(document).scrollLeft(
                    e(document).scrollLeft() - a.scrollSpeed
                  ))
    ...
    e.ui.plugin.add("draggable", "snap", {
      ...
      drag: function (t, i) {
        var a,
          ...
          v = i.offset.top,
          b = v + m.helperProportions.height;
        for (d = m.snapElements.length - 1; d >= 0; d--)
          (o = m.snapElements[d].left),
            (l = o + m.snapElements[d].width),
            (h = m.snapElements[d].top),
            (u = h + m.snapElements[d].height),
            o - f > y ||
            g > l + f ||
            h - f > b ||
            v > u + f ||
            !e.contains(
              m.snapElements[d].item.ownerDocument,
              m.snapElements[d].item
            )
              ? (m.snapElements[d].snapping &&
                  m.options.snap.release &&
                  m.options.snap.release.call(
                    m.element,
                    t,
                    e.extend(m._uiHash(), { snapItem: m.snapElements[d].item })
                  ),
                (m.snapElements[d].snapping = !1))
              : ("inner" !== p.snapMode &&
                  ((a = f >= Math.abs(h - b)),
                  (s = f >= Math.abs(u - v)),
                  (r = f >= Math.abs(o - y)),
                  ...
                  a &&
                    (i.position.top =
                      m._convertPositionTo("relative", {
                        top: h - m.helperProportions.height,
                        left: 0,
                      }).top - m.margins.top),
                  s &&
                    (i.position.top =
                      m._convertPositionTo("relative", { top: u, left: 0 })
                        .top - m.margins.top),
                  r &&
                    (i.position.left =
                      m._convertPositionTo("relative", {
                  ...
                  n &&
                    (i.position.left =
                      m._convertPositionTo("relative", { top: 0, left: l })
                        .left - m.margins.left)),
                (c = a || s || r || n),
                "outer" !== p.snapMode &&
                  ((a = f >= Math.abs(h - v)),
                  ...
                  a &&
                    (i.position.top =
                      m._convertPositionTo("relative", { top: h, left: 0 })
                        .top - m.margins.top),
                  s &&
                    (i.position.top =
                      m._convertPositionTo("relative", {
                  ...
                  r &&
                    (i.position.left =
                      m._convertPositionTo("relative", { top: 0, left: o })
                        .left - m.margins.left),
                  n &&
                    (i.position.left =
                      m._convertPositionTo("relative", {
                        top: 0,
                        left: l - m.helperProportions.width,
                      }).left - m.margins.left)),
                !m.snapElements[d].snapping &&
                  (a || s || r || n || c) &&
                  m.options.snap.snap &&
                  m.options.snap.snap.call(
                    m.element,
                    t,
                    e.extend(m._uiHash(), { snapItem: m.snapElements[d].item })
                  ),
                (m.snapElements[d].snapping = a || s || r || n || c));
      },
    }),
    e.ui.plugin.add("draggable", "stack", {
      start: function () {
        ...
        a.length &&
          ((t = parseInt(e(a[0]).css("zIndex"), 10) || 0),
          e(a).each(function (i) {
...
(function (e) {
  ...
  e.widget("ui.droppable", {
        ...
        ? (this.element
            ...
            .each(function () {
              ...
              return t.options.greedy &&
                ...
                t.accept.call(t.element[0], a.currentItem || a.element) &&
                e.ui.intersect(
                  a,
          ...
          s
            ...
            ? (this.options.activeClass &&
              ...
              this.options.hoverClass &&
                this.element.removeClass(this.options.hoverClass),
              this._trigger("drop", t, this.ui(a)),
              this.element)
            : !1)
        : !1;
    },
    ...
    (e.ui.intersect = function (e, i, a) {
      ...
      switch (a) {
        case "fit":
          return n >= u && c >= l && o >= d && p >= h;
        case "intersect":
          return (
            n + e.helperProportions.width / 2 > u &&
            c > l - e.helperProportions.width / 2 &&
        ...
        case "pointer":
          return (
            ...
            t(r, d, i.proportions().height) && t(s, u, i.proportions().width)
          );
        case "touch":
          return (
            ((o >= d && p >= o) || (h >= d && p >= h) || (d > o && h > p)) &&
            ((n >= u && c >= n) || (l >= u && c >= l) || (u > n && l > c))
          );
        default:
          return !1;
      }
      ...
      prepareOffsets: function (t, i) {
        var a,
          ...
          o = (t.currentItem || t.element)
            .find(":data(ui-droppable)")
            .addBack();
        e: for (a = 0; r.length > a; a++)
          if (
            !(
              r[a].options.disabled ||
              (t &&
                !r[a].accept.call(r[a].element[0], t.currentItem || t.element))
            )
          ) {
            for (s = 0; o.length > s; s++)
              if (o[s] === r[a].element[0]) {
                r[a].proportions().height = 0;
                continue e;
              }
            (r[a].visible = "none" !== r[a].element.css("display")),
              r[a].visible &&
                ("mousedown" === n && r[a]._activate.call(r[a], i),
                (r[a].offset = r[a].element.offset()),
                r[a].proportions({
                  width: r[a].element[0].offsetWidth,
                  height: r[a].element[0].offsetHeight,
                }));
          }
      },
      drop: function (t, i) {
            ...
            if (!this.options.disabled && !this.greedyChild && this.visible) {
              ...
              o &&
                (this.options.greedy &&
                  ...
                  r.length &&
                    ((a = e.data(r[0], "ui-droppable")),
                    (a.greedyChild = "isover" === o))),
                a &&
                  "isover" === o &&
                  ((a.isover = !1), (a.isout = !0), a._out.call(a, i)),
                (this[o] = !0),
                (this["isout" === o ? "isover" : "isout"] = !1),
                this["isover" === o ? "_over" : "_out"].call(this, i),
                a &&
                  "isout" === o &&
                  ((a.isout = !1), (a.isover = !0), a._over.call(a, i)));
            }
          });
      },
  ...
  e.widget("ui.resizable", e.ui.mouse, {
        ...
        for (i in this.handles)
          this.handles[i].constructor === String &&
            ...
            this.elementIsWrapper &&
              ...
              ((a = e(this.handles[i], this.element)),
        ...
        o.autoHide &&
          ...
          e(this.element)
            ...
            .mouseleave(function () {
              o.disabled ||
                n.resizing ||
                (e(this).addClass("ui-resizable-autohide"), n._handles.hide());
            })),
        this._mouseInit();
    },
    _destroy: function () {
    ...
    _mouseCapture: function (t) {
      var i,
        ...
        s = !1;
      for (i in this.handles)
        (a = e(this.handles[i])[0]),
          (a === t.target || e.contains(a, t.target)) && (s = !0);
    ...
    _mouseStart: function (i) {
      ...
      return (
        ...
        (this.originalSize = this._helper
          ...
          : { width: h.width(), height: h.height() }),
        (this.originalPosition = { left: a, top: s }),
        (this.sizeDiff = {
    ...
    _mouseDrag: function (t) {
      ...
      return p
        ? ((i = p.apply(this, [t, d, c])),
          ...
          this.position.left !== h && (s.left = this.position.left + "px"),
          this.size.width !== l && (s.width = this.size.width + "px"),
          this.size.height !== u && (s.height = this.size.height + "px"),
          a.css(s),
          !this._helper &&
    ...
    _mouseStop: function (t) {
      ...
      return (
        this._helper &&
          ...
          (a = i.length && /textarea/i.test(i[0].nodeName)),
          (s = a && e.ui.hasScroll(i[0], "left") ? 0 : u.sizeDiff.height),
          (r = a ? 0 : u.sizeDiff.width),
          (n = { width: u.helper.width() - r, height: u.helper.height() - s }),
          (o =
          ...
          l.animate || this.element.css(e.extend(n, { top: h, left: o })),
    ...
    _updateVirtualBoundaries: function (e) {
      ...
      (n = {
        ...
        (this._aspectRatio || e) &&
          ...
          (a = n.maxHeight * this.aspectRatio),
          (r = n.maxWidth / this.aspectRatio),
          t > n.minWidth && (n.minWidth = t),
          s > n.minHeight && (n.minHeight = s),
          n.maxWidth > a && (n.maxWidth = a),
          n.maxHeight > r && (n.maxHeight = r)),
        (this._vBoundaries = n);
    },
    ...
    _updateRatio: function (e) {
      ...
      return (
        ...
        "sw" === s && ((e.left = t.left + (a.width - e.width)), (e.top = null)),
        "nw" === s &&
    ...
    _respectSize: function (e) {
      ...
      return (
        ...
        n && u && (e.left = h - t.minWidth),
        s && u && (e.left = h - t.maxWidth),
        ...
        for (e = 0; this._proportionallyResizeElements.length > e; e++) {
          if (((s = this._proportionallyResizeElements[e]), !this.borderDif))
            for (
              ...
              this.borderDif[t] =
                (parseInt(i[t], 10) || 0) + (parseInt(a[t], 10) || 0);
          s.css({
    ...
    _change: {
      ...
      w: function (e, t) {
        ...
        return { left: a.left + t, width: i.width - t };
      },
      n: function (e, t, i) {
        var a = this.originalSize,
          s = this.originalPosition;
        return { top: s.top + i, height: a.height - i };
      },
      s: function (e, t, i) {
      ...
      se: function (t, i, a) {
        return e.extend(
          ...
          this._change.e.apply(this, [t, i, a])
        );
      },
      sw: function (t, i, a) {
        return e.extend(
          this._change.s.apply(this, arguments),
          this._change.w.apply(this, [t, i, a])
        );
      },
      ne: function (t, i, a) {
        return e.extend(
    ...
    e.ui.plugin.add("resizable", "animate", {
      stop: function (t) {
        var i = e(this).data("ui-resizable"),
          ...
          h = { width: i.size.width - o, height: i.size.height - n },
          l =
        ...
        i.element.animate(e.extend(h, u && l ? { top: u, left: l } : {}), {
          ...
          step: function () {
            ...
            s && s.length && e(s[0]).css({ width: a.width, height: a.height }),
              i._updateCache(a),
    ...
    e.ui.plugin.add("resizable", "containment", {
        ...
        p &&
          ...
          /document/.test(c) || c === document
            ...
            : ((i = e(p)),
              ...
              (o = e.ui.hasScroll(p, "left") ? p.scrollWidth : n),
              (h = e.ui.hasScroll(p) ? p.scrollHeight : r),
              (l.parentData = {
                element: p,
                left: s.left,
                top: s.top,
      ...
      resize: function (t) {
        ...
        c[0] !== document && /static/.test(c.css("position")) && (d = h),
          l.left < (n._helper ? h.left : 0) &&
            ((n.size.width =
              n.size.width +
              (n._helper
                ? n.position.left - h.left
                : n.position.left - d.left)),
            u && (n.size.height = n.size.width / n.aspectRatio),
            (n.position.left = o.helper ? h.left : 0)),
          l.top < (n._helper ? h.top : 0) &&
            ((n.size.height =
              n.size.height +
              (n._helper ? n.position.top - h.top : n.position.top)),
            u && (n.size.width = n.size.height * n.aspectRatio),
            (n.position.top = n._helper ? h.top : 0)),
          (n.offset.left = n.parentData.left + n.position.left),
          (n.offset.top = n.parentData.top + n.position.top),
          (i = Math.abs(
            (n._helper ? n.offset.left - d.left : n.offset.left - d.left) +
              n.sizeDiff.width
          )),
          (a = Math.abs(
            (n._helper ? n.offset.top - d.top : n.offset.top - h.top) +
              n.sizeDiff.height
          )),
          (s = n.containerElement.get(0) === n.element.parent().get(0)),
          (r = /relative|absolute/.test(n.containerElement.css("position"))),
          s && r && (i -= Math.abs(n.parentData.left)),
          i + n.size.width >= n.parentData.width &&
            ((n.size.width = n.parentData.width - i),
            u && (n.size.height = n.size.width / n.aspectRatio)),
          a + n.size.height >= n.parentData.height &&
            ((n.size.height = n.parentData.height - a),
            u && (n.size.width = n.size.height * n.aspectRatio));
      },
      stop: function () {
        ...
        t._helper &&
          ...
          e(this).css({ left: o.left - s.left - a.left, width: h, height: l }),
          t._helper &&
            !i.animate &&
    ...
    e.ui.plugin.add("resizable", "alsoResize", {
      start: function () {
        ...
        "object" != typeof i.alsoResize || i.alsoResize.parentNode
          ? a(i.alsoResize)
          : i.alsoResize.length
          ? ((i.alsoResize = i.alsoResize[0]), a(i.alsoResize))
    ...
    e.ui.plugin.add("resizable", "grid", {
      resize: function () {
        var t = e(this).data("ui-resizable"),
          ...
          h = o[0] || 1,
          l = o[1] || 1,
          u = Math.round((a.width - s.width) / h) * h,
          d = Math.round((a.height - s.height) / l) * l,
          c = s.width + u,
          p = s.height + d,
          m = i.maxWidth && c > i.maxWidth,
          f = i.maxHeight && p > i.maxHeight,
        ...
        (i.grid = o),
          ...
          /^(se|s|e)$/.test(n)
            ...
            ? ((t.size.width = c),
              (t.size.height = p),
              (t.position.top = r.top - d))
            : /^(sw)$/.test(n)
            ? ((t.size.width = c),
              (t.size.height = p),
              (t.position.left = r.left - u))
            : (p - l > 0
                ? ((t.size.height = p), (t.position.top = r.top - d))
                : ((t.size.height = l),
                  (t.position.top = r.top + s.height - l)),
              c - h > 0
                ? ((t.size.width = c), (t.position.left = r.left - u))
                : ((t.size.width = h),
                  (t.position.left = r.left + s.width - h)));
      },
    });
})(jQuery);
(function (e) {
  e.widget("ui.selectable", e.ui.mouse, {
    ...
    _mouseStart: function (t) {
      ...
      (this.opos = [t.pageX, t.pageY]),
        this.options.disabled ||
          ((this.selectees = e(a.filter, this.element[0])),
          this._trigger("start", t),
          e(a.appendTo).append(this.helper),
          ...
          this.selectees.filter(".ui-selected").each(function () {
            ...
            (a.startselected = !0),
              t.metaKey ||
                ...
                (a.unselecting = !0),
                i._trigger("unselecting", t, { unselecting: a.element }));
          }),
          e(t.target)
            .parents()
            .addBack()
    ...
    _mouseDrag: function (t) {
      if (((this.dragged = !0), !this.options.disabled)) {
        ...
        return (
          r > o && ((i = o), (o = r), (r = i)),
          n > h && ((i = h), (h = n), (n = i)),
          this.helper.css({ left: r, top: n, width: o - r, height: h - n }),
          this.selectees.each(function () {
            var i = e.data(this, "selectable-item"),
              l = !1;
            i &&
              i.element !== a.element[0] &&
              ("touch" === s.tolerance
                ? (l = !(
                    i.left > o ||
                    r > i.right ||
                ...
                : "fit" === s.tolerance &&
                  (l = i.left > r && o > i.right && i.top > n && h > i.bottom),
              l
                ? (i.selected &&
                  ...
                  i.selecting ||
                    ...
                    (i.selecting = !0),
                    a._trigger("selecting", t, { selecting: i.element })))
                : (i.selecting &&
      ...
      return (
        ...
        e(".ui-unselecting", this.element[0]).each(function () {
          ...
          a.$element.removeClass("ui-unselecting"),
            (a.unselecting = !1),
            (a.startselected = !1),
            i._trigger("unselected", t, { unselected: a.element });
        }),
        e(".ui-selecting", this.element[0]).each(function () {
          ...
          a.$element.removeClass("ui-selecting").addClass("ui-selected"),
            ...
            (a.selected = !0),
            (a.startselected = !0),
            i._trigger("selected", t, { selected: a.element });
        }),
...
(function (e) {
  ...
  e.widget("ui.sortable", e.ui.mouse, {
      ...
      return this.reverting
        ...
        : (this._refreshItems(t),
          e(t.target)
            .parents()
            .each(function () {
              return e.data(this, r.widgetName + "-item") === r
                ? ((a = e(this)), !1)
                : undefined;
            }),
          e.data(t.target, r.widgetName + "-item") === r && (a = e(t.target)),
          a
            ? !this.options.handle ||
              i ||
              (e(this.options.handle, a)
                .find("*")
                .addBack()
                .each(function () {
                  this === t.target && (s = !0);
              ...
              s)
              ? ((this.currentItem = a), this._removeCurrentsFromItems(), !0)
              : !1
            : !1);
    },
    ...
    _intersectsWith: function (e) {
      ...
      return "pointer" === this.options.tolerance ||
        ...
        : t + this.helperProportions.width / 2 > r &&
            n > i - this.helperProportions.width / 2 &&
            a + this.helperProportions.height / 2 > o &&
    ...
    _getItemsAsjQuery: function (t) {
      ...
      if (l && t)
        for (a = l.length - 1; a >= 0; a--)
          for (r = e(l[a]), s = r.length - 1; s >= 0; s--)
            (n = e.data(r[s], this.widgetFullName)),
              n &&
                n !== this &&
                !n.options.disabled &&
                h.push([
      ...
      if (c && this.ready)
        for (i = c.length - 1; i >= 0; i--)
          for (s = e(c[i]), a = s.length - 1; a >= 0; a--)
            (r = e.data(s[a], this.widgetFullName)),
              r &&
                r !== this &&
                !r.options.disabled &&
                (d.push([
      ...
      for (i = this.items.length - 1; i >= 0; i--)
        (a = this.items[i]),
          (a.instance !== this.currentContainer &&
            ...
            a.item[0] !== this.currentItem[0]) ||
            ((s = this.options.toleranceElement
              ? e(this.options.toleranceElement, a.item)
              : a.item),
    ...
    _createPlaceholder: function (t) {
      ...
      var i,
        a = t.options;
      (a.placeholder && a.placeholder.constructor !== String) ||
        ((i = a.placeholder),
        (a.placeholder = {
          element: function () {
        ...
        (t.placeholder = e(
          a.placeholder.element.call(t.element, t.currentItem)
        )),
      ...
      for (s = this.containers.length - 1; s >= 0; s--)
        if (!e.contains(this.currentItem[0], this.containers[s].element[0]))
          if (this._intersectsWith(this.containers[s].containerCache)) {
            if (m && e.contains(this.containers[s].element[0], m.element[0]))
              continue;
            (m = this.containers[s]), (f = s);
          } else
            this.containers[s].containerCache.over &&
              (this.containers[s]._trigger("out", a, this._uiHash(this)),
      ...
      if (m)
        if (1 === this.containers.length)
          ...
          for (
            n = 1e4,
              o = null,
              p = m.floating || i(this.currentItem),
              h = p ? "left" : "top",
              l = p ? "width" : "height",
              u = this.positionAbs[h] + this.offset.click[h],
              r = this.items.length - 1;
            r >= 0;
            r--
          )
            e.contains(this.containers[f].element[0], this.items[r].item[0]) &&
              this.items[r].item[0] !== this.currentItem[0] &&
              (!p ||
                t(
                  this.positionAbs.top + this.offset.click.top,
                  this.items[r].top,
              ...
              ((d = this.items[r].item.offset()[h]),
              (c = !1),
              Math.abs(d - u) > Math.abs(d + this.items[r][l] - u) &&
                ((c = !0), (d += this.items[r][l])),
              n > Math.abs(d - u) &&
                ((n = Math.abs(d - u)),
                (o = this.items[r]),
          ...
          o
            ? this._rearrange(a, o, null, !0)
            : this._rearrange(a, null, this.containers[f].element, !0),
    ...
    _createHelper: function (t) {
      ...
      return (
        ...
        (!a[0].style.width || i.forceHelperSize) &&
          a.width(this.currentItem.width()),
        (!a[0].style.height || i.forceHelperSize) &&
        ...
        ("document" === s.containment || "window" === s.containment) &&
          (this.containment = [
            ...
            e("document" === s.containment ? document : window).width() -
              this.helperProportions.width -
              this.margins.left,
            (e("document" === s.containment ? document : window).height() ||
        ...
        /^(document|window|parent)$/.test(s.containment) ||
          ...
          (this.containment = [
            ...
            i.top +
              ...
              this.margins.top,
            i.left +
              (a ? Math.max(t.scrollWidth, t.offsetWidth) : t.offsetWidth) -
              (parseInt(e(t).css("borderLeftWidth"), 10) || 0) -
              (parseInt(e(t).css("paddingRight"), 10) || 0) -
              this.helperProportions.width -
              this.margins.left,
            i.top +
              (a ? Math.max(t.scrollHeight, t.offsetHeight) : t.offsetHeight) -
              (parseInt(e(t).css("borderTopWidth"), 10) || 0) -
      ...
      return (
        ...
        this.originalPosition &&
          ...
          s.grid &&
            ((i =
              this.originalPageY +
              Math.round((n - this.originalPageY) / s.grid[1]) * s.grid[1]),
            (n = this.containment
    ...
    _clear: function (e, t) {
      ...
      if (
        ...
        for (a in this._storedCSS)
          ("auto" === this._storedCSS[a] || "static" === this._storedCSS[a]) &&
            (this._storedCSS[a] = "");
      ...
      for (
        this.fromOutside &&
          ...
          a = this.containers.length - 1;
        a >= 0;
        a--
      )
        t || s.push(i("deactivate", this, this.containers[a])),
          this.containers[a].containerCache.over &&
            (s.push(i("out", this, this.containers[a])),
      ...
      if (
        ...
        if (!t) {
          for (
            this._trigger("beforeStop", e, this._uiHash()), a = 0;
            s.length > a;
            a++
          )
            s[a].call(this, e);
      ...
      if (
        ...
        for (a = 0; s.length > a; a++) s[a].call(this, e);
        this._trigger("stop", e, this._uiHash());
      }
          ...
          this.headers
            ...
            .each(function (t) {
              var i = e(this),
                ...
                r = i.next(),
                s = r.attr("id");
              a || ((a = n + "-header-" + t), i.attr("id", a)),
                s || ((s = n + "-panel-" + t), r.attr("id", s)),
      ...
      _eventHandler: function (t) {
        ...
        t.preventDefault(),
          (s && !i.collapsible) ||
            ...
            ((i.active = n ? !1 : this.headers.index(r)),
            (this.active = s ? e() : r),
            this._toggle(h),
                    ...
                    (i.now = Math.round(e)),
                      "height" !== i.prop
                        ...
                        : "content" !== d.options.heightStyle &&
                          ((i.now = Math.round(s - t.outerHeight() - h)),
                          (h = 0));
                  },
                }),
                undefined)
  ...
  e.widget("ui.autocomplete", {
    ...
    _create: function () {
      ...
      (this.isMultiLine = s
        ...
        (this.valueMethod = this.element[s || n ? "val" : "text"]),
        (this.isNewMenu = !0),
        this.element
        ...
        this._on(this.element, {
          ...
          input: function (e) {
            return a
              ? ((a = !1), e.preventDefault(), undefined)
  ...
  e.widget("ui.button", {
    ...
    _create: function () {
      this.element
        ...
        .bind("reset" + this.eventNamespace, r),
      ...
      null === n.label &&
        ...
        this.buttonElement
          ...
          .bind("mouseenter" + this.eventNamespace, function () {
            n.disabled || (this === t && e(this).addClass("ui-state-active"));
          })
          .bind("mouseleave" + this.eventNamespace, function () {
            n.disabled || e(this).removeClass(u);
          })
    ...
    _destroy: function () {
      this.element.removeClass("ui-helper-hidden-accessible"),
        this.buttonElement
          .removeClass(i + " ui-state-active " + a)
          .removeAttr("role")
    ...
    _resetButton: function () {
      ...
      r.primary || r.secondary
        ? (this.options.text &&
            n.push(
              "ui-button-text-icon" +
                (s ? "s" : r.primary ? "-primary" : "-secondary")
            ),
          r.primary &&
            t.prepend(
...
(function (e, t) {
  ...
  e.extend(a.prototype, {
    ...
    _optionDatepicker: function (a, i, n) {
      ...
      return 2 === arguments.length && "string" == typeof i
        ? "defaults" === i
          ...
          : null
        : ((r = i || {}),
          "string" == typeof i && ((r = {}), (r[i] = n)),
          l &&
            (this._curInst === l && this._hideDatepicker(),
            (o = this._getDateDatepicker(a, !0)),
            (c = this._getMinMaxDate(l, "min")),
            (d = this._getMinMaxDate(l, "max")),
            s(l.settings, r),
            null !== c &&
              r.dateFormat !== t &&
              r.minDate === t &&
              (l.settings.minDate = this._formatDate(l, c)),
            null !== d &&
              r.dateFormat !== t &&
              r.maxDate === t &&
              (l.settings.maxDate = this._formatDate(l, d)),
            "disabled" in r &&
              (r.disabled
                ? this._disableDatepicker(a)
                : this._enableDatepicker(a)),
            this._attachments(e(a), l),
            this._autoSize(l),
            this._setDate(l, o),
    ...
    _doKeyPress: function (a) {
      ...
      return e.datepicker._get(n, "constrainInput")
        ? ((i = e.datepicker._possibleChars(
          ...
          a.ctrlKey || a.metaKey || " " > s || !i || i.indexOf(s) > -1)
        : t;
    },
    _doKeyUp: function (t) {
      var a,
      ...
      if (
        ...
        (a = e.datepicker._getInst(t)),
          ...
          n !== !1 &&
            ...
            (o = e.datepicker._checkOffset(a, o, r)),
            a.dpDiv.css({
              position:
            ...
            a.inline ||
              ((c = e.datepicker._get(a, "showAnim")),
              (d = e.datepicker._get(a, "duration")),
              a.dpDiv.zIndex(e(t).zIndex() + 1),
              (e.datepicker._datepickerShowing = !0),
              e.effects && e.effects.effect[c]
                ? a.dpDiv.show(c, e.datepicker._get(a, "showOptions"), d)
                : a.dpDiv[c || "show"](c ? d : null),
    ...
    _checkOffset: function (t, a, i) {
      ...
      return (
        (a.left -= this._get(t, "isRTL") ? s - r : 0),
        (a.left -=
          i && a.left === t.input.offset().left ? e(document).scrollLeft() : 0),
        (a.top -=
          i && a.top === t.input.offset().top + o
    ...
    _hideDatepicker: function (t) {
      ...
      !o ||
        ...
        (this._datepickerShowing &&
          ((a = this._get(o, "showAnim")),
          (i = this._get(o, "duration")),
          (s = function () {
            e.datepicker._tidyDialog(o);
          }),
          e.effects && (e.effects.effect[a] || e.effects[a])
            ? o.dpDiv.hide(a, e.datepicker._get(o, "showOptions"), i, s)
            : o.dpDiv[
                "slideDown" === a
                  ? "slideUp"
                  : "fadeIn" === a
    ...
    parseDate: function (a, i, s) {
        ...
        b = function (a, s, n) {
          ...
          if (
            (e.each(o, function (e, a) {
              var s = a[1];
              return i.substr(d, s.length).toLowerCase() === s.toLowerCase()
                ? ((r = a[0]), (d += s.length), !1)
                : t;
            }),
            -1 !== r)
      ...
      if (
        ((c = this._daylightSavingAdjust(new Date(f, m - 1, D))),
        c.getFullYear() !== f || c.getMonth() + 1 !== m || c.getDate() !== D)
      )
        throw "Invalid date";
      return c;
    },
      ...
      for (
        e.drawMonth = Z,
          ...
          a = B
            ? this.formatDate(
                a,
                this._daylightSavingAdjust(new Date(et, Z - V, 1)),
                this._getFormatConfig(e)
              )
            : a,
          i = this._canAdjustMonth(e, -1, et, Z)
          ...
          o = this._get(e, "gotoCurrent") && e.currentDay ? Q : W,
          r = B ? this.formatDate(r, o, this._getFormatConfig(e)) : r,
          c = e.inline
            ? ""
        ...
        for (b = "", this.maxRows = 4, w = 0; J[1] > w; w++) {
          ...
          for (
            x +=
              ...
              I +
              "'>" +
              (/all|left/.test(I) && 0 === M ? (H ? n : i) : "") +
              (/all|right/.test(I) && 0 === M ? (H ? i : n) : "") +
          ...
          for (
            x += N + "</tr></thead><tbody>",
              S = this._getDaysInMonth(et, Z),
              et === e.selectedYear &&
                Z === e.selectedMonth &&
                (e.selectedDay = Math.min(e.selectedDay, S)),
              A = (this._getFirstDayOfMonth(et, Z) - l + 7) % 7,
              T = Math.ceil((A + S) / 7),
              F = G ? (this.maxRows > T ? this.maxRows : T) : T,
              this.maxRows = F,
              j = this._daylightSavingAdjust(new Date(et, Z, 1 - A)),
              K = 0;
            F > K;
            K++
          ) {
            for (
              ...
              (E = f ? f.apply(e.input ? e.input[0] : null, [j]) : [!0, ""]),
                (P = j.getMonth() !== Z),
                (L = (P && !D) || !E[0] || ($ && $ > j) || (X && j > X)),
                (O +=
                  "<td class='" +
                  ...
                  ((j.getTime() === C.getTime() &&
                    Z === e.selectedMonth &&
                    e._keyEvent) ||
                  (k.getTime() === j.getTime() && k.getTime() === C.getTime())
                    ? " " + this._dayOverClass
                    : "") +
                  (L
  ...
  e.widget("ui.dialog", {
        ...
        e.isEmptyObject(i) || (e.isArray(i) && !i.length)
          ...
          : (e.each(i, function (i, a) {
              ...
              (a = e.isFunction(a) ? { click: a, text: i } : a),
                ...
                (s = { icons: a.icons, text: a.showText }),
                delete a.icons,
                delete a.showText,
                e("<button></button>", a).button(s).appendTo(t.uiButtonSet);
            }),
    ...
    _makeDraggable: function () {
      ...
      this.uiDialog.draggable({
        ...
        stop: function (r, s) {
          (a.position = [
            s.position.left - i.document.scrollLeft(),
            s.position.top - i.document.scrollTop(),
          ]),
            e(this).removeClass("ui-dialog-dragging"),
            i._unblockFrames(),
            i._trigger("dragStop", r, t(s));
        },
      });
    },
    _makeResizable: function () {
      ...
      var i = this,
        ...
        n = "string" == typeof r ? r : "n,e,s,w,se,sw,ne,nw";
      this.uiDialog
        .resizable({
    ...
    _setOptions: function (a) {
      ...
      e.each(a, function (e, a) {
        r._setOption(e, a), e in t && (s = !0), e in i && (n[e] = a);
      }),
      ...
      "dialogClass" === e &&
        ...
        "disabled" !== e &&
          ...
          "draggable" === e &&
            ...
            i && !t && r.draggable("destroy"),
            !i && t && this._makeDraggable()),
          "position" === e && this._position(),
          "resizable" === e &&
            ((a = r.is(":data(ui-resizable)")),
            a && !t && r.resizable("destroy"),
            a && "string" == typeof t && r.resizable("option", "handles", t),
  ...
  e.widget("ui.menu", {
      ...
      switch (t.keyCode) {
        ...
        default:
          (h = !1),
            ...
            r === s ? (n = !0) : (r = s + r),
            (o = RegExp("^" + i(r), "i")),
            (a = this.activeMenu.children(".ui-menu-item").filter(function () {
              return o.test(e(this).children("a").text());
            })),
            (a =
              n && -1 !== a.index(this.active.next())
      ...
      this.element.toggleClass(
        ...
        a
          ...
          .each(function () {
            ...
            a.attr("aria-haspopup", "true").prepend(s),
              t.attr("aria-labelledby", a.attr("id"));
          }),
    ...
    _scrollIntoView: function (t) {
      ...
      this._hasScroll() &&
        ...
        (a = parseFloat(e.css(this.activeMenu[0], "paddingTop")) || 0),
        (s = t.offset().top - this.activeMenu.offset().top - i - a),
        (r = this.activeMenu.scrollTop()),
        (n = this.activeMenu.height()),
        (o = t.height()),
        0 > s
          ? this.activeMenu.scrollTop(r + s)
          : s + o > n && this.activeMenu.scrollTop(r + s - n + o));
    },
    blur: function (e, t) {
    ...
    _move: function (e, t, i) {
      ...
      this.active &&
        ...
        (a && a.length && this.active) ||
          (a = this.activeMenu.children(".ui-menu-item")[t]()),
        this.focus(i, a);
    },
    nextPage: function (t) {
      var i, a, s;
  ...
  e.widget("ui.slider", e.ui.mouse, {
        ...
        : ((this.elementSize = {
          ...
          o === !1
            ...
            : ((this._mouseSliding = !0),
              ...
              this.handles.hasClass("ui-state-hover") || this._slide(t, n, a),
              (this._animateOff = !0),
              !0));
    },
    _mouseStart: function () {
    ...
    values: function (t, i) {
      ...
      if (!e.isArray(arguments[0]))
        return this.options.values && this.options.values.length
          ...
          : this.value();
      for (
        a = this.options.values, s = arguments[0], r = 0;
        a.length > r;
        r += 1
      )
    ...
    _setOption: function (t, i) {
      ...
      switch (
        ...
        case "values":
          for (
            this._animateOff = !0, this._refreshValue(), a = 0;
            s > a;
            a += 1
          )
            this._change(null, a);
    ...
    _trimAlignValue: function (e) {
      ...
      var t = this.options.step > 0 ? this.options.step : 1,
        ...
        a = e - i;
      return (
        2 * Math.abs(i) >= t && (a += i > 0 ? t : -t), parseFloat(a.toFixed(5))
      );
    },
    _valueMin: function () {
              ...
              h.options.range === !0 &&
                ("horizontal" === h.orientation
                  ...
                  : (0 === a &&
                      h.range
                        .stop(1, 1)
                        [l ? "animate" : "css"]({ bottom: i + "%" }, o.animate),
                    1 === a &&
                      h.range[l ? "animate" : "css"](
                        { height: i - t + "%" },
                        { queue: !1, duration: o.animate }
        ...
        switch (
          ...
          case e.ui.keyCode.PAGE_UP:
            r = this._trimAlignValue(
              s + (this._valueMax() - this._valueMin()) / t
            );
            break;
          case e.ui.keyCode.PAGE_DOWN:
            r = this._trimAlignValue(
  ...
  e.widget("ui.spinner", {
    ...
    _getCreateOptions: function () {
      var t = {},
        i = this.element;
      return (
        e.each(["min", "max", "step"], function (e, a) {
          var s = i.attr(a);
...
(function (e, t) {
  ...
  function a(e) {
    return (
      (e = e.cloneNode(!1)),
      e.hash.length > 1 &&
        decodeURIComponent(e.href.replace(n, "")) ===
          decodeURIComponent(location.href.replace(n, ""))
    );
  }
  var s = 0,
    n = /#.*$/;
  e.widget("ui.tabs", {
    ...
    _initialActive: function () {
      ...
      return (
        null === i &&
          (s &&
            this.tabs.each(function (a, n) {
              return e(n).attr("aria-controls") === s ? ((i = a), !1) : t;
            }),
          null === i &&
    ...
    _processTabs: function () {
      ...
      (this.tablist = this._getList()
        ...
        this.anchors.each(function (i, s) {
          ...
          a(s)
            ? ((n = s.hash), (r = t.element.find(t._sanitizeSelector(n))))
            : ((o = t._tabId(l)),
              (n = "#" + o),
              (r = t.element.find(n)),
              r.length ||
            ...
            l.attr({ "aria-controls": n.substring(1), "aria-labelledby": h }),
    ...
    _eventHandler: function (t) {
      var i = this.options,
        ...
        u = { oldTab: a, oldPanel: l, newTab: o ? e() : n, newPanel: h };
      t.preventDefault(),
      ...
      (this.running = !0),
        o.length && this.options.hide
          ...
          : (i.oldTab
            ...
            o.hide(),
            s()),
        o.attr({ "aria-expanded": "false", "aria-hidden": "true" }),
    ...
    load: function (t, i) {
      ...
      var s = this,
        ...
        h = { tab: n, panel: o };
      a(r[0]) ||
        ((this.xhr = e.ajax(this._ajaxSettings(r, i, h))),
        this.xhr &&
      ...
      return {
        ...
        beforeSend: function (t, n) {
          return s._trigger(
            "beforeLoad",
            i,
            e.extend({ jqXHR: t, ajaxSettings: n }, a)
          );
        },
      };
    },
...
(function (e) {
  ...
  e.widget("ui.tooltip", {
    ...
    _open: function (i, a, s) {
      ...
      if (s) {
        if (((r = this._find(a)), r.length))
          return r.find(".ui-tooltip-content").html(s), void 0;
        a.is("[title]") &&
          (i && "mouseover" === i.type
            ? a.attr("title", "")
            : a.removeAttr("title")),
          ...
          this.options.track && i && /^mouse/.test(i.type)
            ...
            : r.position(e.extend({ of: a }, this.options.position)),
          r.hide(),
          ...
          this._trigger("open", i, { tooltip: r }),
          (o = {
            keyup: function (t) {
    ...
    _tooltip: function (t) {
      ...
      return (
        e("<div>").addClass("ui-tooltip-content").appendTo(s),
  ...
  (e.effects = { effect: {} }),
    (function (e, t) {
      ...
      function a(i) {
        ...
        return (
          ...
          m(h, function (e, r) {
            ...
            return h
              ? ((n = a[l](h)),
                (a[u[l].cache] = n[u[l].cache]),
                (s = a._rgba = n._rgba),
                !1)
              : t;
          }),
          s.length
            ? ("0,0,0,0" === s.join() && e.extend(s, r.transparent), a)
            : r[i]
        );
      }
      function s(e, t, i) {
      ...
      var r,
        ...
        l = (e.Color = function (t, i, a, s) {
          return new e.Color.fn.parse(t, i, a, s);
        }),
        u = {
          rgba: {
            props: {
      ...
      (p.style.cssText = "background-color:rgba(1,1,1,.5)"),
        ...
        (l.fn = e.extend(l.prototype, {
          parse: function (s, n, o, h) {
            if (s === t) return (this._rgba = [null, null, null, null]), this;
            (s.jquery || s.nodeType) && ((s = e(s).css(n)), (n = t));
            var d = this,
              c = e.type(s),
              p = (this._rgba = []);
            return (
              n !== t && ((s = [s, n, o, h]), (c = "array")),
              "string" === c
                ? this.parse(a(s) || r._default)
                : "array" === c
                ? (m(u.rgba.props, function (e, t) {
                    p[t.idx] = i(s[t.idx], t);
                  }),
                  this)
                : "object" === c
                ? (s instanceof l
                    ...
                    : m(u, function (t, a) {
                        ...
                        m(a.props, function (e, t) {
                          ...
                          d[r] &&
                            0 > e.inArray(null, d[r].slice(0, 3)) &&
                            ((d[r][3] = 1), a.from && (d._rgba = a.from(d[r])));
                      }),
                  this)
                : t
            );
          ...
          is: function (e) {
            ...
            return (
              m(u, function (e, r) {
                ...
                return (
                  o &&
                    ((n = s[r.cache] || (r.to && r.to(s._rgba)) || []),
                    m(r.props, function (e, i) {
                      return null != o[i.idx] ? (a = o[i.idx] === n[i.idx]) : t;
                    })),
                  a
                );
              }),
        ...
        (u.hsla.to = function (e) {
          ...
          return (
            ...
            [Math.round(t) % 360, i, d, null == n ? 1 : n]
          );
        }),
        ...
        m(u, function (a, s) {
          var r = s.props,
            ...
            u = s.from;
          (l.fn[a] = function (a) {
            if ((h && !this[n] && (this[n] = h(this._rgba)), a === t))
              return this[n].slice();
            var s,
              o = e.type(a),
              d = "array" === o || "object" === o ? a : arguments,
              c = this[n].slice();
            return (
              m(r, function (e, t) {
                var a = d["object" === o ? e : t.idx];
                null == a && (a = c[t.idx]), (c[t.idx] = i(a, t));
              }),
              u ? ((s = l(u(c))), (s[n] = c), s) : l(c)
            );
          }),
            m(r, function (t, i) {
              l.fn[t] ||
                (l.fn[t] = function (s) {
                  var r,
                    n = e.type(s),
                    h = "alpha" === t ? (this._hsla ? "hsla" : "rgba") : a,
                    l = this[h](),
                    u = l[i.idx];
                  return "undefined" === n
                    ? u
                    : ("function" === n &&
                        ((s = s.call(this, u)), (n = e.type(s))),
                      null == s && i.empty
                        ? this
                        : ("string" === n &&
                            ((r = o.exec(s)),
          ...
          m(i, function (t, i) {
            (e.cssHooks[i] = {
              set: function (t, s) {
                ...
                if (
                  "transparent" !== s &&
                  ("string" !== e.type(s) || (r = a(s)))
                ) {
                  if (((s = l(r || s)), !c.rgba && 1 !== s._rgba[3])) {
                    for (
                      ...
                      try {
                        (o = e.css(n, "backgroundColor")), (n = n.parentNode);
                      } catch (h) {}
        ...
        (e.cssHooks.borderColor = {
          expand: function (e) {
            var t = {};
            return (
              m(["Top", "Right", "Bottom", "Left"], function (i, a) {
                t["border" + a + "Color"] = e;
              }),
              t
            );
    ...
    (function () {
      function i(t) {
        ...
        if (s && s.length && s[0] && s[s[0]])
          for (a = s.length; a--; )
            (i = s[a]), "string" == typeof s[i] && (r[e.camelCase(i)] = s[i]);
        else for (i in s) "string" == typeof s[i] && (r[i] = s[i]);
        return r;
      }
      function a(t, i) {
        var a,
        ...
        for (a in i)
          (s = i[a]),
            t[a] !== s &&
              (r[a] || ((e.fx.step[a] || !isNaN(parseFloat(s))) && (n[a] = s)));
        return n;
      }
        ...
        e.fn.extend({
          addClass: (function (t) {
            return function (i, a, s, r) {
              return a
                ? e.effects.animateClass.call(this, { add: i }, a, s, r)
          ...
          removeClass: (function (t) {
            return function (i, a, s, r) {
              return arguments.length > 1
                ? e.effects.animateClass.call(this, { remove: i }, a, s, r)
                : t.apply(this, arguments);
            };
          })(e.fn.removeClass),
          toggleClass: (function (i) {
            return function (a, s, r, n, o) {
              return "boolean" == typeof s || s === t
                ...
                : e.effects.animateClass.call(this, { toggle: a }, s, r, n);
            };
          })(e.fn.toggleClass),
      ...
      e.extend(e.effects, {
        ...
        restore: function (e, a) {
          ...
          for (r = 0; a.length > r; r++)
            null !== a[r] &&
              ((s = e.data(i + a[r])), s === t && (s = ""), e.css(a[r], s));
        },
...
(function (e) {
  ...
  e.effects.effect.blind = function (a, s) {
    ...
    l.parent().is(".ui-effects-wrapper")
      ...
      : e.effects.save(l, h),
      l.show(),
      (r = e.effects.createWrapper(l).css({ overflow: "hidden" })),
      (n = r[p]()),
      (o = parseFloat(r.css(m)) || 0),
      (g[p] = y ? n : 0),
      f ||
        (l
...
(function (e) {
  e.effects.effect.bounce = function (t, i) {
    var a,
      ...
      l = e.effects.setMode(n, t.mode || "effect"),
      h = "hide" === l,
      u = "show" === l,
      d = t.direction || "up",
      c = t.distance,
    ...
    for (
      (u || h) && o.push("opacity"),
        ...
        c || (c = n["top" === y ? "outerHeight" : "outerWidth"]() / 3),
        u &&
          ((r = { opacity: 1 }),
          (r[y] = 0),
          n
    ...
    h &&
      ...
      x > 1 && b.splice.apply(b, [1, 0].concat(b.splice(x, m + 1))),
      n.dequeue();
  };
})(jQuery);
(function (e) {
  e.effects.effect.clip = function (t, i) {
    var a,
      ...
      n = e(this),
      o = ["position", "top", "bottom", "left", "right", "height", "width"],
      l = e.effects.setMode(n, t.mode || "hide"),
      h = "show" === l,
    ...
    e.effects.save(n, o),
      n.show(),
      (a = e.effects.createWrapper(n).css({ overflow: "hidden" })),
      (s = "IMG" === n[0].tagName ? a : n),
      (r = s[c]()),
      h && (s.css(c, 0), s.css(p, r / 2)),
      (m[c] = h ? r : 0),
      (m[p] = h ? 0 : r / 2),
      s.animate(m, {
        queue: !1,
...
(function (e) {
  e.effects.effect.explode = function (t, i) {
    ...
    var r,
      ...
      b = [];
    for (r = 0; d > r; r++)
      for (l = g.top + r * v, u = r - (d - 1) / 2, n = 0; c > n; n++)
        (o = g.left + n * y),
          (h = n - (c - 1) / 2),
          p
            .clone()
...
(function (e) {
  e.effects.effect.fold = function (t, i) {
    ...
    e.effects.save(r, n),
      r.show(),
      (a = e.effects.createWrapper(r).css({ overflow: "hidden" })),
      (s = p ? [a.width(), a.height()] : [a.height(), a.width()]),
      d && (u = (parseInt(d[1], 10) / 100) * s[h ? 0 : 1]),
      l && a.css(c ? { height: 0, width: u } : { height: u, width: 0 }),
      (g[m[0]] = l ? s[0] : u),
      (y[m[1]] = l ? s[1] : 0),
      a.animate(g, f, t.easing).animate(y, f, t.easing, function () {
        h && r.hide(), e.effects.restore(r, n), e.effects.removeWrapper(r), i();
      });
  };
})(jQuery);
(function (e) {
  e.effects.effect.highlight = function (t, i) {
    var a = e(this),
      ...
      n = { backgroundColor: a.css("backgroundColor") };
    "hide" === r && (n.opacity = 0),
      e.effects.save(a, s),
      a
        .show()
        ...
        .animate(n, {
          ...
          easing: t.easing,
          complete: function () {
            "hide" === r && a.hide(), e.effects.restore(a, s), i();
          },
        });
  };
})(jQuery);
(function (e) {
  e.effects.effect.pulsate = function (t, i) {
    var a,
      ...
      p = c.length;
    for (
      (n || !s.is(":visible")) && (s.css("opacity", 0).show(), (d = 1)), a = 1;
      h > a;
      a++
    )
      s.animate({ opacity: d }, u, t.easing), (d = 1 - d);
    s.animate({ opacity: d }, u, t.easing),
      s.queue(function () {
        o && s.hide(), i();
      }),
  ...
  (e.effects.effect.puff = function (t, i) {
    ...
    (e.effects.effect.scale = function (t, i) {
      var a = e(this),
        ...
        n =
          ...
          (0 === parseInt(t.percent, 10) ? 0 : "hide" === r ? 0 : 100),
        o = t.direction || "both",
        h = t.origin,
        l = {
          height: a.height(),
      ...
      (s.effect = "size"),
        ...
        (s.complete = i),
        "effect" !== r &&
          ((s.origin = h || ["middle", "center"]), (s.restore = !0)),
        (s.from =
          t.from ||
          ("show" === r
        ...
        s.fade &&
          ("show" === r && ((s.from.opacity = 0), (s.to.opacity = 1)),
          "hide" === r && ((s.from.opacity = 1), (s.to.opacity = 0))),
        a.effect(s);
    }),
    (e.effects.effect.size = function (t, i) {
      var a,
        ...
        p = e.effects.setMode(n, t.mode || "effect"),
      ...
      "show" === p && n.show(),
        ...
        "toggle" === t.mode && "show" === p
          ? ((n.from = t.to || b), (n.to = t.from || a))
          : ((n.from = t.from || ("show" === p ? b : a)),
            (n.to = t.to || ("hide" === p ? b : a))),
        (r = {
          from: { y: n.from.height / a.height, x: n.from.width / a.width },
          to: { y: n.to.height / a.height, x: n.to.width / a.width },
        }),
        ("box" === f || "both" === f) &&
          (r.from.y !== r.to.y &&
            ((v = v.concat(d)),
            (n.from = e.effects.setTransition(n, d, r.from.y, n.from)),
            (n.to = e.effects.setTransition(n, d, r.to.y, n.to))),
          r.from.x !== r.to.x &&
            ((v = v.concat(c)),
            (n.from = e.effects.setTransition(n, c, r.from.x, n.from)),
            (n.to = e.effects.setTransition(n, c, r.to.x, n.to)))),
        ("content" === f || "both" === f) &&
          r.from.y !== r.to.y &&
          ((v = v.concat(u).concat(l)),
          (n.from = e.effects.setTransition(n, u, r.from.y, n.from)),
          (n.to = e.effects.setTransition(n, u, r.to.y, n.to))),
        e.effects.save(n, v),
        n.show(),
        e.effects.createWrapper(n),
        n.css("overflow", "hidden").css(n.from),
        g &&
          ((s = e.effects.getBaseline(g, a)),
          (n.from.top = (a.outerHeight - n.outerHeight()) * s.y),
          (n.from.left = (a.outerWidth - n.outerWidth()) * s.x),
          (n.to.top = (a.outerHeight - n.to.outerHeight) * s.y),
          (n.to.left = (a.outerWidth - n.to.outerWidth) * s.x)),
        n.css(n.from),
        ("content" === f || "both" === f) &&
          ...
          n.find("*[width]").each(function () {
            ...
            m && e.effects.save(i, l),
              (i.from = {
                height: a.height * r.from.y,
                width: a.width * r.from.x,
                outerHeight: a.outerHeight * r.from.y,
                outerWidth: a.outerWidth * r.from.x,
              }),
              (i.to = {
                height: a.height * r.to.y,
                width: a.width * r.to.x,
                outerHeight: a.height * r.to.y,
                outerWidth: a.width * r.to.x,
              }),
              r.from.y !== r.to.y &&
                ((i.from = e.effects.setTransition(i, d, r.from.y, i.from)),
                (i.to = e.effects.setTransition(i, d, r.to.y, i.to))),
              r.from.x !== r.to.x &&
                ((i.from = e.effects.setTransition(i, c, r.from.x, i.from)),
                (i.to = e.effects.setTransition(i, c, r.to.x, i.to))),
              i.css(i.from),
              ...
              m ||
                ("static" === y
                  ...
                  : e.each(["top", "left"], function (e, t) {
                      n.css(t, function (t, i) {
                        var a = parseInt(i, 10),
                          s = e ? n.to.left : n.to.top;
...
(function (e) {
  e.effects.effect.shake = function (t, i) {
    ...
    for (
      ...
      s.animate(f, d, t.easing).animate(g, d, t.easing);
    s
...
(function (e) {
  e.effects.effect.slide = function (t, i) {
    ...
    e.effects.save(s, r),
      s.show(),
      (a = t.distance || s["top" === l ? "outerHeight" : "outerWidth"](!0)),
      e.effects.createWrapper(s).css({ overflow: "hidden" }),
      o && s.css(l, u ? (isNaN(a) ? "-" + a : -a) : a),
      (d[l] = (o ? (u ? "+=" : "-=") : u ? "-=" : "+=") + a),
      s.animate(d, {
        queue: !1,
        duration: t.duration,
